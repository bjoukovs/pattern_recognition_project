...
PCAFISHER_mapping2 = feature_extraction(train, true, 0, 100)
...
plote({EPCA_NMC, EPCA_PARZEN, EPCA_FISHER, EPCA_KNN});

%Evaluation of the PCA+Fisher mapping
figure
EPCAF = clevalf(train*PCAFISHER_mapping, nmc, 1:9, [],  1, tst*PCAFISHER_mapping);
EPCAF_PARZEN = clevalf(train*PCAFISHER_mapping, nmc, 1:9, [], 1, tst*PCAFISHER_mapping);
...
EPCAF2_PARZEN = clevalf(train*PCAFISHER_mapping2, nmc, 1:9, [], 1, tst*PCAFISHER_mapping2);
...
plote({EPCAF2, EPCAF2_PARZEN, EPCAF2_FISHER, EPCAF2_KNN});
